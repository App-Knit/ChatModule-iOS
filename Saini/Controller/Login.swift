...
//    }//Resend OTP
    ...
    func navigateToUsersMap(){
        let storyBoard = UIStoryboard(name: "Main", bundle: nil)
        let UsersMap = storyBoard.instantiateViewController(withIdentifier: "UsersMap") as! UsersMap
        self.navigationController?.pushViewController(UsersMap, animated: true)
